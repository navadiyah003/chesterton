        ...
        <div class="dashboard-ecommerce">
            <div class="container-fluid dashboard-content ">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h3 class="card-header" style="background:rgb(230, 83, 103)">Edit Timeline</h3>
                                <div class="card-body">
                                    <form action="{{ route('admin.update-timeline',$timeline->id )}}" method="POST" id="form" data-parsley-validate="" novalidate="" enctype="multipart/form-data">
                                       @csrf 
                                        @method('PUT')
                                       ...
                                       <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <input type="text" id="year" name="year"  value="{{ $timeline->year }}" data-parsley-type="" placeholder="" class="form-control">
                                                @if($errors->has('year'))
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <input type="file" id="timeline_image" name="timeline_image"  data-parsley-type="" placeholder="" class="form-control form-control-lg">
                                                  <img src="{{ asset('admin/uploads/timeline/timeline_image/'.$timeline->timeline_image) }}" width="70px" height="70px" alt="Image">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <input type="text" id="timeline_title" name="timeline_title" value="{{ $timeline->timeline_title }}" data-parsley-type="" placeholder="" class="form-control">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <textarea class="form-control" id="timeline_desc" name="timeline_desc" rows="3">{{ $timeline->timeline_desc }}</textarea>
