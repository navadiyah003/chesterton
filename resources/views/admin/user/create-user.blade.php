        ...
        <div class="dashboard-ecommerce">
            <div class="container-fluid dashboard-content ">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h3 class="card-header" style="background:rgb(230, 83, 103)">Add User</h3>
                                <div class="card-body">
                                    <form action="{{ route('admin.add-user')}}" method="POST" id="form" data-parsley-validate="" novalidate="" enctype="multipart/form-data">
                                       @csrf 
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">                                               
                                                 <input type="text" id="email" name="email"  data-parsley-type="" placeholder="" class="form-control">
                                                @if($errors->has('email'))
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">                                               
                                                 <input type="password" id="password" name="password"  data-parsley-type="" placeholder="" class="form-control">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <input type="text" id="mobile_no" name="mobile_no"  data-parsley-type="" placeholder="" class="form-control">
                                             ...
                                             <div class="col-9 col-lg-10 ">     
                                                <div class="form-check form-check-inline">
                                                    <label class="form-check-label" for="male">
                                                        <input type="radio" class="form-check-input"  name="gender" id="male" value="Male" style="display:inline-block">Male
                                                    </label>
                                                </div>
                                                 <div class="form-check form-check-inline">
                                                    <label class="form-check-label" for="female">
                                                        <input type="radio" class="form-check-input"  name="gender" id="female" value="Female" style="display:inline-block">Female
                                                    </label>
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <textarea class="form-control" id="user_address" name="address" rows="3"></textarea>
