                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h3 class="card-header" style="background:rgb(230, 83, 103)">Add Team Member</h3>
                                <div class="card-body">
                                    <form action="{{ route('admin.update-our-team',$our_team->id)}}" method="POST" id="form" data-parsley-validate="" novalidate="" enctype="multipart/form-data">
                                       @csrf 
                                       @method('PUT')
                                        <div class="form-group row">
                                            <label for="member_name" class="col-3 col-lg-2 col-form-label text-right"> Member Name:</label>
                                            <div class="col-9 col-lg-10">
                                                <input type="text" id="member_name" name="member_name"  data-parsley-type="" value="{{ $our_team->member_name }}" placeholder="" class="form-control">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <input type="text" id="member_position" name="member_position"  data-parsley-type="" value="{{ $our_team->member_position }}" placeholder="" class="form-control">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <textarea class="form-control" id="member_desc" name="member_desc" rows="3">{{ $our_team->member_desc }}</textarea>
                                        ...
                                        <div class="form-group row">     
                                            ...
                                            <div class="col-9 col-lg-10">                             
                                                <input type="file" class="form-control form-control-lg" name="member_image" id="member_image" required />
                                                 <img src="{{ asset('/admin/uploads/our-team/member_image/'.$our_team->member_image) }}" width="70px" height="70px" alt="Image">
