                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h3 class="card-header" style="background:rgb(230, 83, 103)">Add Story</h3>
                                <div class="card-body">
                                    <form action="{{ route('admin.about-us.store')}}" method="POST" id="form" data-parsley-validate="" novalidate="" enctype="multipart/form-data">
                                       @csrf 
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <input type="text" id="description" name="description"  data-parsley-type="" placeholder="" class="form-control">
