...
<div class="dashboard-ecommerce">
    <div class="container-fluid dashboard-content ">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <h3 class="card-header" style="background:rgb(230, 83, 103)">Edit Service Explore</h3>
                <div class="card-body">
                    <form action="{{route('admin.service-explore.update',$about->id)}}" method="POST" id="form"
                            ...
                            <div class="col-9 col-lg-10">
                                <select class="form-control" name="service_title" id="service_title">
                                    ...
                                    @foreach ($service as $item)
                                        <option value="{{ $item->id }}" @if ($about->service_id == $item->id)
                                            selected
                                        @endif >{{ $item->titles }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9 col-lg-10">
                                <input type="text" id="title" name="title" data-parsley-type="" placeholder="" value="{{ $about->title }}"
                                    class="form-control">
                                @if($errors->has('title'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9 col-lg-10">
                                <input type="text" id="link" name="link" data-parsley-type="" placeholder="" value="{{ $about->link }}"
                                    class="form-control">
                                @if($errors->has('link'))
