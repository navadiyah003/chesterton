...
<div class="d-flex justify-content-end mr-5">
    <a href="{{ url('admin/service-consultants/create')}}" class="btn btn-primary "><i
            class="fa fa-plus-circle fa-fw me-1"></i>
        Create  Consultants</a>
</div>
<div class="dashboard-ecommerce">
    <div class="container-fluid dashboard-content ">
        <div class="col-lg-12">
            <div class="card">
                <h3 class="card-header" style="background:rgb(230, 83, 103)"> Service Consultants List</h3>
                <div class="input-group col-lg-4 offset-3 mb-3 mt-4">
                    <input type="search" name="consultants_search" id="consultants_search" class="form-control" value="{{ request('consultants_search')}}" placeholder="Search..."/>
                </div> 
                                ...
                                <tr id="{{ $item->id }}">
                                    ...
                                    <td>
                                        <a class="btn btn-primary btn-md"
                                            href="{{route('admin.service-consultants.edit', $item->id) }}"><i
    ...
    swal({
        ...
        .then((willDelete) => {
            ...
            if (willDelete) {
                $.ajax({
                    type: 'POST',
                    url: "{{ url('/admin/delete-consultants')}}/" + id,
                    data: {
                        id: id,
                        "_token": "{{csrf_token()}}",
                    },
