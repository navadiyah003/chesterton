...
<div class="dashboard-ecommerce">
    <div class="container-fluid dashboard-content ">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <h3 class="card-header" style="background:rgb(230, 83, 103)">Edit Service Main</h3>
                <div class="card-body">
                    <form action="{{route('admin.update-service',$about->id)}}" method="POST" id="form"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9 col-lg-10">
                                <input type="text" id="title" name="title" data-parsley-type="" placeholder="" value="{{ $about->titles }}"
                                    class="form-control">
                                @if($errors->has('title'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9 col-lg-10">
                                <input type="text" id="description" name="description" data-parsley-type="" placeholder="" value="{{ $about->description }}"
                                    class="form-control">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9 col-lg-10">
                                <textarea class="form-control" id="service_main_content" name="content" rows="3">{{ $about->content }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9 col-lg-10">
                                <input type="file" class="form-control form-control-lg" name="main_image" id="image"
                                    required />
                                    <img src="{{ asset('/admin/uploads/service/'.$about->main_image) }}" width="70px"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9 col-lg-10">
                                <input type="file" class="form-control form-control-lg" name="image" id="image"
                                    required />
                                <img src="{{ asset('/admin/uploads/service/'.$about->image) }}" width="70px"
                                            height="70px" alt="Image">
