...
<div class="dashboard-ecommerce">
    <div class="container-fluid dashboard-content ">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <h3 class="card-header" style="background:rgb(230, 83, 103)">Add Service Valuation</h3>
                <div class="card-body">
                    <form action="{{ route('admin.service-valution.store')}}" method="POST" id="form"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9 col-lg-10">
                                <input type="text" name="valution_content" data-parsley-type="" placeholder=""
                                    class="form-control">
