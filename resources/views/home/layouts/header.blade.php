...
<body>
    <div class="overlay-mobile-menu" id="overlay"></div>
    ...
    <header class="home-header ">
        <div class="container-fluid">
            <div class="row header-row">
                ...
                <div class="col-10 header-col-right menu-main-wrap" id="slide-nav">
                    <div class="close-menu-div">
                        <div class="close-menu" id="close-menu">
                            <svg xmlns="http://www.w3.org/2000/svg" width="15.58" height="15.58"
                                viewBox="0 0 15.58 15.58">
                                <g id="Group_30972" data-name="Group 30972"
                                    transform="translate(-712.045 -893.087) rotate(45)">
                                    <path id="Path_1925" data-name="Path 1925" d="M1087-234v18.033"
                                        transform="translate(59.016 353)" fill="none" stroke="#fff"
                                        stroke-linecap="round" stroke-width="2" />
                                    <path id="Path_1926" data-name="Path 1926" d="M0,0V18.033"
                                        transform="translate(1155.033 128.016) rotate(90)" fill="none" stroke="#fff"
                                        stroke-linecap="round" stroke-width="2" />
                                </g>
                            </svg>
                    ...
                    <div class="menu-sec">
                        <ul class="border-anim">
                            ...
                            <li class="menu-item-has-children"><a href="#">Global Network</a>
                                <div class="menu-subs">
                                    <div class="row">
                            ...
                            <li class="menu-item-has-children"><a href="{{ url('/career') }}">Careers</a>
                                <div class="menu-subs">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <h1>test</h1>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70"
                                    ...
                                    <g id="Group_31313" data-name="Group 31313" transform="translate(10816 23657)">
                                        <g id="Ellipse_39" data-name="Ellipse 39"
                                            transform="translate(-10816 -23657)" fill="none" stroke="#bc8418"
                                            stroke-width="1.5">
                                        ...
                                        <path id="Icon_feather-phone-call" data-name="Icon feather-phone-call"
                                            ...
                                            transform="translate(-10795.502 -23634.855)" fill="none"
                        ...
                        <a href="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                ...
                                <g id="Group_31944" data-name="Group 31944" transform="translate(-60 -640)">
                                    <circle id="Ellipse_39" data-name="Ellipse 39" cx="16" cy="16"
                                        r="16" transform="translate(60 640)" fill="#bc8418" />
                                    <g id="Icon_feather-mail" data-name="Icon feather-mail"
                                        transform="translate(69 651)">
                                        <path id="Path_2656" data-name="Path 2656"
                                            d="M4.314,6h10.51a1.318,1.318,0,0,1,1.314,1.314V15.2a1.318,1.318,0,0,1-1.314,1.314H4.314A1.318,1.318,0,0,1,3,15.2V7.314A1.318,1.318,0,0,1,4.314,6Z"
                                            transform="translate(-3 -6)" fill="none" stroke="#fff"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" />
                                        <path id="Path_2657" data-name="Path 2657" d="M16.137,9,9.569,13.6,3,9"
                                            transform="translate(-3 -7.686)" fill="none" stroke="#fff"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" />
                                    </g>
                                </g>
                            </svg>
